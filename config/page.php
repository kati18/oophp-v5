...
return [
    ...
    "views" => [
        [
            ...
            "data" => [
                "class" => "large",
                "siteLogo" => "image/theme/cherry-blossom.png",
                "siteLogoAlt"   => "Cherry-blossom",
            ],
        ],
        [
            "region" => "header-col-1",
            ...
            "data" => [
                "homeLink"      => "",
                "siteLogoText"  => "oophp",
                "siteLogoTextIcon" => "image/theme/cherry-blossom_small.png",
                "siteLogoTextIconAlt" => "Cherry-blossom",
            ],
        ],
        [
            "region" => "header-col-2",
